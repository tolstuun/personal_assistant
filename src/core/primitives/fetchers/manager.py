...
class FetcherManager:
    ...
    async def _fetch_source(self, session, source: Source) -> dict:
        ...
        Returns:
            Dict with stats: found, new, filtered.
        """
        ...
        # Save articles
        saved_count, filtered_count = await self._save_articles(
        ...
        logger.info(
            ...
            f"new {stats['new']}, filtered {stats['filtered']}"
        )
    ...
    async def _save_articles(
        ...
        """
        Save articles to database with deduplication and filtering.
        ...
        Returns:
            Tuple of (saved_count, filtered_count).
        """
        saved_count = 0
        filtered_count = 0
